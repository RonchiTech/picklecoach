...
export default async function AdminSubscriptionsPage() {
  ...
  return (
    <div>
      <h1 className="font-outfit text-3xl font-bold text-text-primary">Subscriptions</h1>
      <p className="mt-1 text-sm text-text-secondary">Manage coach subscription tiers</p>
          ...
          <tbody>
            {(coaches ?? []).map((coach, i) => (
              ...
              >
                ...
                <td className="px-4 py-3">
                  <SubscriptionManager coach={coach} />
                </td>
              </tr>
            ))}
          </tbody>
